...
?>
<!DOCTYPE html>
<html lang="es" data-au-theme="light">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" href="../../src/img/logos/logo_icon.png" type="image/x-icon">
    <title>15-92 | Usuarios</title>
    <script>
        (function () {
            var saved = localStorage.getItem('au-theme') || 'light';
            document.documentElement.setAttribute('data-au-theme', saved);
        })();
    </script>
...
<body>
    ...
    <main>
        ...
        <div id="main__content">
            ...
            <!-- Modulo Usuarios -->
            <script src="js/usuarios.js?t=<?php echo time(); ?>"></script>
        </div>
    </main>
</body>
</html>

        ...
        foreach ($ls as $_key) {
            ...
            for ($m = 1; $m <= 12; $m++) {
                ...
                $mes['Cheque Prom. '.$mesLetra] = [
                 ...
                 if (!isset($totalCol['Total '.$mesLetra])) $totalCol['Total '.$mesLetra] = 0;
                 if (!isset($totalCol['Ocup '.$mesLetra])) $totalCol['Ocup '.$mesLetra] = 0;
                 if (!isset($totalCol['Cheque Prom. '.$mesLetra])) $totalCol['Cheque Prom. '.$mesLetra] = 0;
                 
                 $totalCol['Total '.$mesLetra]          += $monto['total'];
                 $totalCol['Ocup '.$mesLetra]            += $ocup['pax'];
                 $totalCol['Cheque Prom. '.$mesLetra]    += ($chequePromedio !== '' ? $chequePromedio : 0);

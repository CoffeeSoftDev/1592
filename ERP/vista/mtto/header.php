      ...
      <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
       ...
       <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
         ...
         <!-- <li> <a style="text-decoration:none" href="mtto"><span class="icon-cog-1"></span> FLORES</a></li> -->


         <li> <a style="text-decoration:none" href="mtto_catalogo"><span class="icon-book"></span> CATÁLOGO</a></li>

         <li class="dropdown">
          <a style="text-decoration:none; " href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="icon-doc-text"></span> REQUISICIÓN <span class="caret"></span></a>
          <ul class="dropdown-menu">
           <li><a style="text-decoration:none" href="inventario_productos"><span class="icon-doc-text"></span> INVENTARIO</a></li>
           <li role="separator" class="divider"></li>
           <li><a style="text-decoration:none" href="lista_inv_productos"><span class="icon-doc-text"></span> LISTA INV.</a></li>
           <li role="separator" class="divider"></li>
           <li><a style="text-decoration:none" href="requisicion"><span class="icon-doc-text"></span> REQUISICIÓN</a></li>
          </ul>
         </li>

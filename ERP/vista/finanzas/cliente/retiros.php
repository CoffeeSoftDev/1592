<?php
  ...
  // if ( $_SESSION['nivel'] != 3 || $_SESSION['nivel'] != 0 ) {
...
<body>
 ...
 <script src="recursos/js/format_number.js" charset="utf-8"></script>
 <script src="recursos/js/finanzas/cliente/ret_rem.js?t=<?=time()?>" charset="utf-8"></script>
